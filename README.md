...
local C_BG2     = Color3.fromRGB(25, 25, 25)      -- fundo secundÃ¡rio
local C_BG3     = Color3.fromRGB(30, 30, 30)      -- fundo terciÃ¡rio
...
do -- JANELA (Prime Duels â€” tema roxo)
    ...
    menuBtn.Text="â‰¡"; menuBtn.TextColor3=C_WHITE
    ...
    do
        ...
        cb.Text="Ã—"; cb.TextColor3=C_WHITE
    ...
    local function ToggleFloat(tabName,label,eKey,buildFn,cb)
        ...
        local function resizeFP()
            if fpCollapsed then
                ...
                fpBody.Visible=false; fphLine.Visible=false; arrowLbl.Text="â–¶"
            else
                ...
                fpBody.Visible=true; fphLine.Visible=true; arrowLbl.Text="â–²"
            end
        end
